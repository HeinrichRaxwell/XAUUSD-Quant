...
Sample of verified live execution records generated by the **QuantOS ML Engine**:

| Type | Volume | Entry Price | Stop Loss (SL) | Take Profit (TP) | Exit Price | Realized PnL | Execution Tag |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| `SELL` | `0.01 lot` | `$4,065.96` | `$4,082.00` | `$4,048.00` | `$4,063.46` | `+$2.50 USD` | `SL+ (Profit Lock)` |
| `SELL` | `0.01 lot` | `$4,062.77` | `$4,078.00` | `$4,045.00` | `$4,060.27` | `+$2.50 USD` | `SL+ (Profit Lock)` |
| `SELL` | `0.01 lot` | `$4,060.13` | `$4,075.00` | `$4,042.00` | `$4,057.63` | `+$2.50 USD` | `SL+ (Profit Lock)` |
| `SELL` | `0.01 lot` | `$4,057.28` | `$4,072.00` | `$4,039.00` | `$4,049.10` | `+$8.18 USD` | `SL+ (Peak Lock)` |
| `SELL` | `0.01 lot` | `$4,048.99` | `$4,064.00` | `$4,032.00` | `$4,046.50` | `+$2.49 USD` | `SL+ (Profit Lock)` |
| `SELL` | `0.01 lot` | `$4,046.15` | `$4,061.00` | `$4,029.00` | `$4,030.15` | `+$16.00 USD` | `TP (Target Hit)` |
